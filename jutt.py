...
__copyright = 'All rights reserved . Copyright  Muhammad.Noman'
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/03086951294')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                ok = open('/sdcard/ids/NOMI_OK.txt', 'a')
